...
public class Configuration {
    public InteractionContext wifiBump(InteractionApplication context) {
        ...
        InteractionContext interactionContext = new InteractionContext(registerBumpListener(context), Selection.Empty, new WifiDirectChannel(wifiP2pManager, channel, context));
    ...
    private BumpDetector registerBumpListener(Context context) {
        return new BumpDetector((SensorManager) context.getSystemService(Context.SENSOR_SERVICE), Threshold.LOW);
    }
