...
import hs_mannheim.stitch.animations.AnimationsContainer;
import hs_mannheim.stitch.animations.ElevateAndLeaveAnimator;
import hs_mannheim.stitch.animations.FlipSelectAnimator;
import hs_mannheim.stitch.animations.FlyInAndLowerAnimator;
import hs_mannheim.stitch.animations.OnAnimationStoppedListener;
...
public class ConnectedActivity extends AppCompatActivity implements IViewContext, ILifecycleListener, IPacketReceiver, SwipeDetector.SwipeEventListener, OnAnimationStoppedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewWrapper = new ViewWrapper(findViewById(R.id.connected_activity_layout));
        ...
        mSendAnimator = new ElevateAndLeaveAnimator(this, findViewById(R.id.imgView));
        mSelectAnimator = new FlipSelectAnimator(this, findViewById(R.id.imgView));
        mReceiveAnimator = new FlyInAndLowerAnimator(this, findViewById(R.id.imgView));
